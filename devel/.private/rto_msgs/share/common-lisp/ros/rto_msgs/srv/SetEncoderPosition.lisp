...
(cl:defmethod cl:initialize-instance :after ((m <SetEncoderPosition-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetEncoderPosition-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rto_msgs-srv:<SetEncoderPosition-request> is deprecated: use rto_msgs-srv:SetEncoderPosition-request instead.")))

(cl:ensure-generic-function 'position-val :lambda-list '(m))
(cl:defmethod position-val ((m <SetEncoderPosition-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rto_msgs-srv:position-val is deprecated.  Use rto_msgs-srv:position instead.")
  (position m))

(cl:ensure-generic-function 'velocity-val :lambda-list '(m))
(cl:defmethod velocity-val ((m <SetEncoderPosition-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rto_msgs-srv:velocity-val is deprecated.  Use rto_msgs-srv:velocity instead.")
  (velocity m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SetEncoderPosition-request>)))
  ...
  "rto_msgs/SetEncoderPositionRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetEncoderPosition-request)))
  "Returns string type for a service object of type 'SetEncoderPosition-request"
  "rto_msgs/SetEncoderPositionRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <SetEncoderPosition-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetEncoderPosition-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rto_msgs-srv:<SetEncoderPosition-response> is deprecated: use rto_msgs-srv:SetEncoderPosition-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SetEncoderPosition-response>)))
  ...
  "rto_msgs/SetEncoderPositionResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetEncoderPosition-response)))
  "Returns string type for a service object of type 'SetEncoderPosition-response"
  "rto_msgs/SetEncoderPositionResponse")
