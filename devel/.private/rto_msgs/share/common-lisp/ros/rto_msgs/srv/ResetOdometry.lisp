...
(cl:defmethod cl:initialize-instance :after ((m <ResetOdometry-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ResetOdometry-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rto_msgs-srv:<ResetOdometry-request> is deprecated: use rto_msgs-srv:ResetOdometry-request instead.")))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <ResetOdometry-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rto_msgs-srv:x-val is deprecated.  Use rto_msgs-srv:x instead.")
  (x m))

(cl:ensure-generic-function 'y-val :lambda-list '(m))
(cl:defmethod y-val ((m <ResetOdometry-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rto_msgs-srv:y-val is deprecated.  Use rto_msgs-srv:y instead.")
  (y m))

(cl:ensure-generic-function 'phi-val :lambda-list '(m))
(cl:defmethod phi-val ((m <ResetOdometry-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rto_msgs-srv:phi-val is deprecated.  Use rto_msgs-srv:phi instead.")
  (phi m))
...
(cl:defmethod cl:initialize-instance :after ((m <ResetOdometry-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ResetOdometry-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rto_msgs-srv:<ResetOdometry-response> is deprecated: use rto_msgs-srv:ResetOdometry-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ResetOdometry-response>)))
  ...
  "rto_msgs/ResetOdometryResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ResetOdometry-response)))
  "Returns string type for a service object of type 'ResetOdometry-response"
  "rto_msgs/ResetOdometryResponse")
