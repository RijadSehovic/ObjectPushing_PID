...
(cl:defmethod cl:initialize-instance :after ((m <SetBHAPressures>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetBHAPressures)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rto_msgs-msg:<SetBHAPressures> is deprecated: use rto_msgs-msg:SetBHAPressures instead.")))
