...
(cl:defmethod cl:initialize-instance :after ((m <GripperState>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GripperState)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rto_msgs-msg:<GripperState> is deprecated: use rto_msgs-msg:GripperState instead.")))
...
(cl:defmethod state-val ((m <GripperState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rto_msgs-msg:state-val is deprecated.  Use rto_msgs-msg:state instead.")
  (state m))
