...
(cl:defmethod cl:initialize-instance :after ((m <SetGrapplerAxes>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetGrapplerAxes)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rto_msgs-msg:<SetGrapplerAxes> is deprecated: use rto_msgs-msg:SetGrapplerAxes instead.")))
...
(cl:defmethod angles-val ((m <SetGrapplerAxes>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rto_msgs-msg:angles-val is deprecated.  Use rto_msgs-msg:angles instead.")
  (angles m))
