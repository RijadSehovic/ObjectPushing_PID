...
(cl:defmethod cl:initialize-instance :after ((m <PowerReadings>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'PowerReadings)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rto_msgs-msg:<PowerReadings> is deprecated: use rto_msgs-msg:PowerReadings instead.")))
...
(cl:defmethod voltage-val ((m <PowerReadings>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rto_msgs-msg:voltage-val is deprecated.  Use rto_msgs-msg:voltage instead.")
  (voltage m))
