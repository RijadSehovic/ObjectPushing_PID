...
(cl:defmethod cl:initialize-instance :after ((m <DigitalReadings>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'DigitalReadings)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rto_msgs-msg:<DigitalReadings> is deprecated: use rto_msgs-msg:DigitalReadings instead.")))
...
(cl:defmethod values-val ((m <DigitalReadings>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rto_msgs-msg:values-val is deprecated.  Use rto_msgs-msg:values instead.")
  (values m))
