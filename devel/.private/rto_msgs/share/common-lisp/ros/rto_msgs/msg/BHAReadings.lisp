...
(cl:defmethod cl:initialize-instance :after ((m <BHAReadings>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'BHAReadings)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rto_msgs-msg:<BHAReadings> is deprecated: use rto_msgs-msg:BHAReadings instead.")))
...
(cl:defmethod pressures-val ((m <BHAReadings>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rto_msgs-msg:pressures-val is deprecated.  Use rto_msgs-msg:pressures instead.")
  (pressures m))

(cl:ensure-generic-function 'cablepull-val :lambda-list '(m))
(cl:defmethod cablepull-val ((m <BHAReadings>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rto_msgs-msg:cablepull-val is deprecated.  Use rto_msgs-msg:cablepull instead.")
  (cablepull m))
