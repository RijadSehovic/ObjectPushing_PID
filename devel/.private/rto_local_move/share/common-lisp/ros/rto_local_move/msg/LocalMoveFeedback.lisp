...
(cl:defmethod cl:initialize-instance :after ((m <LocalMoveFeedback>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'LocalMoveFeedback)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rto_local_move-msg:<LocalMoveFeedback> is deprecated: use rto_local_move-msg:LocalMoveFeedback instead.")))

(cl:ensure-generic-function 'forward_dist_x-val :lambda-list '(m))
(cl:defmethod forward_dist_x-val ((m <LocalMoveFeedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rto_local_move-msg:forward_dist_x-val is deprecated.  Use rto_local_move-msg:forward_dist_x instead.")
  (forward_dist_x m))

(cl:ensure-generic-function 'forward_dist_y-val :lambda-list '(m))
(cl:defmethod forward_dist_y-val ((m <LocalMoveFeedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rto_local_move-msg:forward_dist_y-val is deprecated.  Use rto_local_move-msg:forward_dist_y instead.")
  (forward_dist_y m))

(cl:ensure-generic-function 'rotation_dist-val :lambda-list '(m))
(cl:defmethod rotation_dist-val ((m <LocalMoveFeedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rto_local_move-msg:rotation_dist-val is deprecated.  Use rto_local_move-msg:rotation_dist instead.")
  (rotation_dist m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<LocalMoveFeedback>)))
  ...
  "rto_local_move/LocalMoveFeedback")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'LocalMoveFeedback)))
  "Returns string type for a message object of type 'LocalMoveFeedback"
  "rto_local_move/LocalMoveFeedback")
