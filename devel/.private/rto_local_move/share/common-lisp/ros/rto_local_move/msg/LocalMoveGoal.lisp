...
(cl:in-package rto_local_move-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <LocalMoveGoal>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'LocalMoveGoal)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rto_local_move-msg:<LocalMoveGoal> is deprecated: use rto_local_move-msg:LocalMoveGoal instead.")))

(cl:ensure-generic-function 'move_x-val :lambda-list '(m))
(cl:defmethod move_x-val ((m <LocalMoveGoal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rto_local_move-msg:move_x-val is deprecated.  Use rto_local_move-msg:move_x instead.")
  (move_x m))

(cl:ensure-generic-function 'move_y-val :lambda-list '(m))
(cl:defmethod move_y-val ((m <LocalMoveGoal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rto_local_move-msg:move_y-val is deprecated.  Use rto_local_move-msg:move_y instead.")
  (move_y m))

(cl:ensure-generic-function 'rotation-val :lambda-list '(m))
(cl:defmethod rotation-val ((m <LocalMoveGoal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rto_local_move-msg:rotation-val is deprecated.  Use rto_local_move-msg:rotation instead.")
  (rotation m))

(cl:ensure-generic-function 'ignore_rotation-val :lambda-list '(m))
(cl:defmethod ignore_rotation-val ((m <LocalMoveGoal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rto_local_move-msg:ignore_rotation-val is deprecated.  Use rto_local_move-msg:ignore_rotation instead.")
  (ignore_rotation m))
